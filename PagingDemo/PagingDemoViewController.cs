...
{
    public partial class PagingDemoViewController : UIViewController
    {
        public PagingDemoViewController(IntPtr handle) : base(handle)
        {
        }
        ...
        UIPageingScrollView ScrollPageView {get; set;}
